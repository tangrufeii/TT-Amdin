package com.tt.server.config.jackson.module;
...
import com.tt.common.pool.StringPools;
            ...
            public List<BeanPropertyWriter> changeProperties(SerializationConfig config, BeanDescription beanDesc, List<BeanPropertyWriter> beanProperties) {
                beanProperties.forEach(propertyWriter -> {
                    ...
                    if (javaType.isTypeOrSubTypeOf(String.class) || javaType.isTypeOrSubTypeOf(CharTypes.class) ||
                            javaType.isTypeOrSubTypeOf(LocalDateTime.class) || javaType.isTypeOrSubTypeOf(Date.class) ||
